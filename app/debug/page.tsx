    ...
    <main className="relative min-h-screen overflow-hidden bg-[#080810] text-[#ddddf0]">
      ...
      <section className="relative mx-auto flex w-full max-w-3xl flex-col gap-8 px-5 py-14 sm:px-8">
        <header className="relative text-center">
          <div className="fixed right-[25px] top-[15px] z-20 flex gap-4">
            <Link
              href="/"
              className="font-mono text-xs uppercase tracking-[0.14em] text-[#f5db5a] transition hover:text-[#ffe992]"
            >
              Home
            </Link>
            <Link
              href="/about"
              className="font-mono text-xs uppercase tracking-[0.14em] text-[#7db6ff] transition hover:text-[#a9ceff]"
            >
              About
            </Link>
          </div>
          <h1 className="ambient-title-home font-mono text-5xl font-bold tracking-tight">
            <span className="ambient-title-home__text">AMBIENT MIXER DEBUG</span>
          </h1>
          <p className="mt-3 font-mono text-[11px] uppercase tracking-[0.28em] text-[#55556a]">
            Calm sound layers + player timeline
          </p>
